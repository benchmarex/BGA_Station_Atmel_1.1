...
/* ATMega128 port pinout for LCD. */
/* 0.2.6 bug, fixed */
#define LCD_DC_PIN                PB7 // PB0  /* Pin 0 */
#define LCD_CE_PIN                PB6 // PB2  /* Pin 2 */
#define SPI_MOSI_PIN              PB2 // PB3  /* Pin 3 */
#define LCD_RST_PIN               PD2 // PB4  /* Pin 4 */
#define SPI_CLK_PIN               PB1 // PB5  /* Pin 5 */

#define SPI_MISO_PIN			  PB3
#define MAX_1_CS_PIN			  PB4
#define MAX_0_CS_PIN 		      PB5
